...
<div class="page-wrap">
  ...
  <div class="side-panel">
    ...
    <p>Connect with organizations, collaborate on academic projects, and unlock opportunities designed for future talent.</p>
    <div class="avatars">
    ...
    <div class="form-inner">
      ...
      <form action="Auth/register.php" method="POST" novalidate>
        <div class="form-group">
          ...
          <input type="text" id="full_name" name="full_name" placeholder="Alex Johnson"
          ...
          <div class="form-group">
            ...
            <select id="year" name="year" required>
              ...
              <?php foreach (['Year 1','Year 2','Year 3','Year 4','Year 5'] as $y): ?>
                <option value="<?= $y ?>" <?= (($_SESSION['old']['year'] ?? '') === $y) ? 'selected' : '' ?>><?= $y ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
