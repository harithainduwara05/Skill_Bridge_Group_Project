...
<div class="dash-wrapper">
    ...
    <!-- Main Section with Notification Overlay Container -->
    <div class="main-content">
        ...
        <header class="dash-header">
            ...
            <div class="header-right">
                <div class="notification-trigger-wrapper">
                    <button class="icon-btn notification-btn active-bell" id="btnToggleNotifications">
        ...
        <main class="page-body">
            <!-- Background content canvas underneath the popup -->
        </main>
    </div>
</div>
