...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 03, 2026 at 07:22 PM
...
('AdminHI', 'skillbridge62@gmail.com', 'admin_1787125323_6a855e4b16fe8.jpeg', '');
...
INSERT INTO `company` (`Email`, `Name`, `companytype`, `contactPersonName`, `contactNumber`, `website`, `location`, `Status`) VALUES
('hr@company.com ', 'HR Pvt LTD', 'IT', 'Nadeeka Munasingha', '0772343234', 'www.hr.com', 'hr pvt ltd,colombo 7', 'Verify');
...
(1, 'UI/UX Designer', 'TechFlow Solutions', 'IT Services', '', '', 'Figma, Adobe XD', '6 Months', 'Nov 15, 2026'),
(2, 'Backend Developer Intern', 'Global Retail', 'Software Development', 'GR', 'background: #dbeafe;', 'Node.js, PostgreSQL', '3 Months', 'Oct 20, 2026');
...
('MYDB', 'General', 'Haritha Induwara', '0779063904', '', '', '2024is052@stu.ucsc.cmb.ac.lk', NULL, NULL, NULL, NULL, NULL);
...
(1, 'AI Model Optimization', 'TechCorp Solutions', NULL, '📊', 'High Demand', 'high-demand', 'Python, TensorFlow, AWS', '3 Months', 4, 'Oct 20, 2026', NULL, NULL, NULL, NULL, NULL, 'Intermediate', 'Any Year', 'Public', 'open', '2026-08-17 19:16:49'),
(2, 'Cloud Migration UI/UX', 'EduConnect', NULL, '🎨', 'UI/UX', 'ui-ux', 'React, Figma, Tailwind', '2 Months', 2, 'Nov 15, 2026', NULL, NULL, NULL, NULL, NULL, 'Intermediate', 'Any Year', 'Public', 'open', '2026-08-17 19:16:49');
...
(1, '2024is058@stu.ucsc.cmb.ac.lk', 'React', NULL, 'Advanced', '1 year', 0, 'Pending');
...
('2024is058@stu.ucsc.cmb.ac.lk', 'University OF Colombo', 'Year 1', 'B.tech', 'Haritha Induwara', 'profile_1786995576_6a836378cc4ba.png', '', '', '', '', 0),
('harithainduwara10@gmail.com', 'Uni co MB', '2024', 'B.tech', 'Haritha Induwara', NULL, NULL, NULL, NULL, NULL, 0);
...
('University OF Colombo', 14, 'School Of Computing', 'stu.ucsc.cmb.ac.lk', 'Active', 'colombo 7');
...
('2024is052@stu.ucsc.cmb.ac.lk', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'organization', 'Active', '', '2026-08-19 08:26:27'),
('2024is058@stu.ucsc.cmb.ac.lk', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'student', 'Active', '', '2026-08-17 19:19:32'),
('harithainduwara05@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Organization', 'Active', '', NULL),
('harithainduwara10@gmail.com', '7c222fb2927d828af22f592134e8932480637c0d', 'student', 'Active', '', '2026-08-19 06:54:51'),
('hr@company.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'company', 'Active', '', '2026-07-05 18:30:00'),
('skillbridge62@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'admin', 'Active', '', '2026-08-18 18:51:43');
...
--
ALTER TABLE `student_projects`
  MODIFY `student_project_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
