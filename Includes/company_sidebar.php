...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="Usermanagemen.php" class="<?= in_array($currentPage, ['Usermanagemen.php', 'users.php']) ? 'active' : '' ?>" title="Internships">
                <span class="icon">
            ...
            <a href="internships.php" class="<?= $currentPage == 'internships.php' ? 'active' : '' ?>" title="Interviews">
                <span class="icon">
